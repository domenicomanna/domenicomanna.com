...
const ThemeToggle: FC = () => {
  const onToggleThemeClick = () => {
    ...
    const syntaxHighlightingTheme = syntaxHighlightingThemeMap[toggledTheme];
    ...
    localStorage.setItem(localStorageThemeKey, toggledTheme);
  };

  return (
    <button className={styles.themeToggle} onClick={onToggleThemeClick}>
      <svg width="22px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path
